...
const form10choiceElement = document.getElementById('field-10');
const form11choiceElement = document.getElementById('field-11');
...
form10choiceElement.addEventListener('change', function() {
    if (form11choiceElement.value == 'AMD') {
      form12choiceElement.value = (form10choiceElement.value/todayUSDRate).toFixed(4);
